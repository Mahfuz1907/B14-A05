...
function Functionalities({TechnologiesPromise}:TechnologiesPromiseTypes) {
    ...
    return (
        <div className='px-5 sm:px-10 md:px-25 mt-28 mb-17.5 flex flex-col justify-between items-start gap-5'>
            ...
            <div className='grid md:grid-cols-3 lg:grid-cols-4 justify-between items-start gap-8 w-full'>
