...
function Footer() {
    return (
        <div className='border border-[#f1f5f9] bg-white px-25 pt-16 pb-12 flex flex-col justify-between items-start gap-14'>
            <div className='flex flex-row justify-start items-start gap-10 lg:gap-40'>
