...
function Banner() {
    return (
        <div className='px-5 sm:px-25 flex flex-row justify-between items-center w-full'>
            <div className='flex flex-col justify-between items-start gap-6 flex-1'>
                <h1 className='flex flex-col justify-center items-start gap-1 inter text-6xl font-extrabold'>
                ...
                <p className='text-[#475569] pjs text-lg font-normal'>Explore frontend, backend, database, and tooling options,
                   compare them side by side, and put together the stack that fits your
                   next project.</p>
                <div className='flex flex-row justify-start items-center gap-3 inter'>
